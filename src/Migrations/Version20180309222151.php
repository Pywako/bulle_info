 ...
 */
class Version20180309222151 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE alert (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, type VARCHAR(100) NOT NULL, comment VARCHAR(100) NOT NULL, UNIQUE INDEX UNIQ_17FD46C1A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE resource (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, subject_id INT DEFAULT NULL, title VARCHAR(100) NOT NULL, summary VARCHAR(350) NOT NULL, creation_date DATETIME NOT NULL, update_date DATETIME NOT NULL, relevance INT NOT NULL, tag VARCHAR(100) NOT NULL, INDEX IDX_BC91F416A76ED395 (user_id), INDEX IDX_BC91F41623EDC87 (subject_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE resource_alert (resource_id INT NOT NULL, alert_id INT NOT NULL, INDEX IDX_3C463CF389329D25 (resource_id), INDEX IDX_3C463CF393035F72 (alert_id), PRIMARY KEY(resource_id, alert_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(100) NOT NULL, last_name VARCHAR(100) NOT NULL, email VARCHAR(100) NOT NULL, subscription_date DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE resource_alert ADD CONSTRAINT FK_3C463CF389329D25 FOREIGN KEY (resource_id) REFERENCES resource (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE resource_alert ADD CONSTRAINT FK_3C463CF393035F72 FOREIGN KEY (alert_id) REFERENCES alert (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE resource_alert DROP FOREIGN KEY FK_3C463CF393035F72');
        $this->addSql('ALTER TABLE category_subject DROP FOREIGN KEY FK_3C167E0412469DE2');
        $this->addSql('ALTER TABLE resource_alert DROP FOREIGN KEY FK_3C463CF389329D25');
        ...
        $this->addSql('DROP TABLE resource_alert');
